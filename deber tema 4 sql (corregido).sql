...
-- Ejercicio 24. CORREGIDO

create temporary table avg_global as
select round(avg(promedio_global.length),0) as prom_global
...
from film as peli, avg_global as pg
where peli.length > pg.prom_global
...
-- Ejercicio 33. CORREGIDO
-- 2 opciones
-- Mismo resultado si se quitan los NULL
...
/* 50. Calcula la duración total de las películas en la categoría 'Action'
 No entiendo la pregunta. El enunciado me dice que sume las duraciones de todas las películos de acción?? no me hace sentido 
